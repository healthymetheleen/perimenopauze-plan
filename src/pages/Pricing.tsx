...
const plans: Plan[] = [
  {
    ...
    price: '€0',
    period: 'voor altijd',
    description: 'Begin met je eetdagboek en ontdek de basis.',
    features: [
      { text: 'Dagelijks eetdagboek', included: true },
      { text: 'Symptomen bijhouden', included: true },
      { text: 'Dagelijkse samenvatting', included: true },
      { text: '7 dagen historie', included: true },
      { text: 'Trends en analyses', included: false },
  ...
  },
  {
    ...
    price: '€9,99',
    period: 'per maand',
    description: 'Ontdek patronen en krijg dieper inzicht.',
    features: [
      { text: 'Dagelijks eetdagboek', included: true },
      { text: 'Symptomen bijhouden', included: true },
      { text: 'Dagelijkse samenvatting', included: true },
      { text: '90 dagen historie', included: true },
      { text: 'Trends en analyses', included: true },
